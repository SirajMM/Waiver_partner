...
//                         : () => controller.createOrder(controller
//                             .todayBalanceAmount.value!
//                             .abs()
//                             .toString()),
//                   ),
//                 );
...
class EarningGraphBar extends StatelessWidget {
  final EarningsByDay? graphValue;

  const EarningGraphBar({super.key, required this.graphValue});
        ...
        return Column(
          ...
          children: [
            AnimatedContainer(
              ...
              height: controller.maxValue.value > 0
                  ? (graphValue?.total ?? 0) * (110 / controller.maxValue.value)
                  : 0,
              width: ((Get.width - 60.sp) / 8) - 5.sp,
            ),
            ...
            Text(graphValue?.day != null
                ? DateFormat("E").format(graphValue!.day!)
                : "")
          ],
        );
      }),
...
class EarningListingItem extends StatelessWidget {
  final EarningListItem earning;

  const EarningListingItem({super.key, required this.earning});
              ...
              Row(
                ...
                children: [
                  ...
                  Obx(() {
                    final balanceAmount =
                        controller.todayBalanceAmount.value ?? 0;
                    bool shouldDisable = balanceAmount >= 0 ||
                        controller.isPaymentSuccessful.value ||
                        controller.isPaymentProcessing.value;
                    ...
                    return Opacity(
                      ...
                      child: BlueButton(
                        ...
                        onTap: shouldDisable
                            ? () {}
                            : () => controller
                                .createOrder(balanceAmount.abs().toString()),
                      ),
                    );
                  })
                ],
        ...
        children: [
          Row(
            ...
            children: [
              ...
              SizedBox(width: 10.sp),
              Obx(() {
                final balanceAmount = controller.weeklyBalanceAmount.value ?? 0;
                bool shouldDisable = balanceAmount == 0 ||
                    controller.isPaymentSuccessful.value ||
                    controller.isPaymentProcessing.value;
                ...
                return Opacity(
                  ...
                  child: BlueButton(
                    ...
                    onTap: shouldDisable
                        ? () {}
                        : () =>
                            controller.createOrder(balanceAmount.toString()),
                  ),
                );
              })
            ],
        ...
        Expanded(
          child: GetX<EarningController>(builder: (controller) {
            return controller.selectGraphValue.value?.day == null
                ...
                : Text(
                    DateFormat("EEE dd MMM yyyy").format(
                        controller.selectGraphValue.value?.day ??
                            DateTime.now()),
                    style: TextStyle(
                        color: Get.theme.indicatorColor.withOpacity(.05),
                        fontSize: 14.sp),
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              GetX<EarningController>(builder: (controller) {
                return Text(
                  "₹ ${controller.weeklyTripFare.value ?? 0.0}",
                  style:
                      TextStyle(fontSize: 14.sp, fontWeight: FontWeight.w600),
                );
              }),
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Obx(() => Text(
                "${AppConstants.formatSecondsToHrAndMinForDouble(item.value.value ?? 0)}",
                style: TextStyle(
                    fontSize: 14.sp,
                    fontWeight: FontWeight.w500,
                    color: AppColors.black),
