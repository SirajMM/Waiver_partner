...
class RegistrationCertificateScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: appBar(title: ""),
        body: GetX<RegistrationCertificateController>(builder: (controller) {
              ...
              : controller.isError.value
                  ...
                  : ListView(
                      ...
                      children: [
                        ...
                        SizedBox(
                          height: 180.sp,
                          child: GetX<RegistrationCertificateController>(
                              builder: (controller) {
                            return ListView(
                              shrinkWrap: true,
                        ...
                        controller.isRejected
                                ...
                                children: [
                                  SizedBox(
                                    ...
                                    child: BlueButton(
                                      ...
                                      onTap: () => Get.bottomSheet(
                                          const AppealForRejectionBottomSheetRegistarionCertificte(),
                                  ...
                                  SizedBox(
                                    ...
                                    child: BlueButton(
                                      text: "Upload",
                                      onTap: () =>
                                          RegistrationCertificateController.to
                                              .uploadDocument(),
                                      prefixIcon: CircleWithIcon(
                                        height: 25.sp,
                                        color: AppColors.white,
                            ...
                            : SizedBox(
                                ...
                                child: BlueButton(
                                  text: "Upload",
                                  onTap: () => RegistrationCertificateController
                                      .to
                                      .uploadDocument(),
                                  prefixIcon: CircleWithIcon(
                                    height: 25.sp,
...
class AppealForRejectionBottomSheetRegistarionCertificte
    extends StatelessWidget {
  const AppealForRejectionBottomSheetRegistarionCertificte({super.key});
    ...
    return Container(
      ...
      child: ListView(
        ...
        children: [
          ...
          Text(
            RegistrationCertificateController.to.rejectionReason,
            style: TextStyle(color: AppColors.red),
          ),
          Form(
            key: RegistrationCertificateController
                .to.uploadProofAadharCardFormKey,
            child: AppTextFormField(
              controller:
                  RegistrationCertificateController.to.userResponseToRejection,
              header: "Appeal",
          ...
          BlueButton(
            text: "Appeal",
            onTap: () => RegistrationCertificateController.to
