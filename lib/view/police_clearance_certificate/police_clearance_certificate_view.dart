...
class PoliceClearanceCertificateScreen extends StatelessWidget {
  const PoliceClearanceCertificateScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: appBar(title: ""),
        body: GetX<PoliceClearanceCertificateController>(builder: (controller) {
              ...
              : controller.isError.value
                  ...
                  : ListView(
                      ...
                      children: [
                        ...
                        SizedBox(
                          height: 180.sp,
                          child: GetX<PoliceClearanceCertificateController>(
                              builder: (controller) {
                            return ListView(
                              shrinkWrap: true,
                        ...
                        GetX<PoliceClearanceCertificateController>(
                            builder: (controller) {
                          return controller
                                  .showErrorMessagePoliceClearanceCertificate
                                  .value
                              ? Column(
                        ...
                        controller.isRejected
                                ...
                                children: [
                                  SizedBox(
                                    ...
                                    child: BlueButton(
                                      ...
                                      onTap: () => Get.bottomSheet(
                                          const AppealForRejectionBottomSheetPoliceClearnce(),
                                  ...
                                  SizedBox(
                                    ...
                                    child: BlueButton(
                                      text: "Upload",
                                      onTap: () =>
                                          PoliceClearanceCertificateController
                                              .to
                                              .uploadDocument(),
                                      prefixIcon: CircleWithIcon(
                                        height: 25.sp,
                            ...
                            : SizedBox(
                                ...
                                child: BlueButton(
                                  text: "Upload",
                                  onTap: () =>
                                      PoliceClearanceCertificateController.to
                                          .uploadDocument(),
                                  prefixIcon: CircleWithIcon(
                                    height: 25.sp,
                                    color: AppColors.white,
...
class AppealForRejectionBottomSheetPoliceClearnce extends StatelessWidget {
  const AppealForRejectionBottomSheetPoliceClearnce({super.key});
    ...
    return Container(
      ...
      child: ListView(
        ...
        children: [
          ...
          Text(
            PoliceClearanceCertificateController.to.rejectionReason,
            style: TextStyle(color: AppColors.red),
          ),
          Form(
            key: PoliceClearanceCertificateController
                .to.uploadProofPoliceClearenceFormKey,
            child: AppTextFormField(
              controller: PoliceClearanceCertificateController
                  .to.userResponseToRejection,
              header: "Appeal",
          ...
          BlueButton(
            text: "Appeal",
            onTap: () => PoliceClearanceCertificateController.to
